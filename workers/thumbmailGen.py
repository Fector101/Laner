...
def generate_alot_of_thumbnails(video_paths, output_dir, time=1.0, max_threads=4):
    """
...
if __name__ == "__main__":
    ...
    generate_alot_of_thumbnails(video_files, output_directory, time=2.0, max_threads=8)
