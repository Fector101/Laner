...
requirements = python3,kivy,https://github.com/kivymd/KivyMD/archive/master.zip,materialyoucolor,asynckivy,asyncgui,pyjnius,docutils,netifaces,filetype,requests_toolbelt,websockets, https://github.com/Fector101/android_notify/archive/main.zip,python-osc,https://github.com/kivy/plyer/archive/master.zip
...
services = Download:./android/services/download.py:foreground,Upload:./android/services/upload.py:True,Sendnoti:./android/services/old.py:True,Mydownloader:./android/services/mydownloader.py:foreground
...
android.permissions = INTERNET, VIBRATE, FOREGROUND_SERVICE, FOREGROUND_SERVICE_DATA_SYNC, POST_NOTIFICATIONS, SET_WALLPAPER, android.permission.ACCESS_ALL_DOWNLOADS, READ_EXTERNAL_STORAGE, MANAGE_EXTERNAL_STORAGE
